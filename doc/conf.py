# -*- coding: utf-8 -*-
#
# XBeePyLibrary documentation build configuration file, created by
# sphinx-quickstart on Fri Oct 24 18:10:43 2014.
#
...
htmlhelp_basename = 'XBeePyLibrarydoc'
...
latex_documents = [
  ('index', 'XBeePyLibrary.tex', u'XBeePyLibrary Documentation',
   u'Daniel', 'manual'),
]
...
man_pages = [
    ('index', 'xbeepylibrary', u'XBeePyLibrary Documentation',
     [u'Daniel'], 1)
]
...
texinfo_documents = [
  ('index', 'XBeePyLibrary', u'XBeePyLibrary Documentation',
   u'Daniel', 'XBeePyLibrary', 'One line description of project.',
   'Miscellaneous'),
]
