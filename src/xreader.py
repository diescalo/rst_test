...
from src.models.xmsg import XBeeMessage, ExplicitXBeeMessage, IPMessage, \
    SMSMessage
from src.models.xopts import ReceiveOptions
from src.models.xprot import XBeeProtocol
from src.packets import xfactory
from src.packets.aft import ApiFrameType
from src.packets.common import ReceivePacket
from src.packets.raw import RX64Packet, RX16Packet
from src.util import utils
from src.xexc import TimeoutException
from src.xio import IOSample
...
class DiscoveryProcessFinished(XBeeEvent):
    """
    This event is fired when something different to the discovery
    of a remote XBee occurs. (Errors, discovering process finished, etc.)
...
class PacketListener(threading.Thread):
    ...
    def __create_remote_device_from_packet(self, xbee_packet):
        ...
        return src.devices.RemoteXBeeDevice(self.__xbee_device, x64bit_addr, x16bit_addr)
