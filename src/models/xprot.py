...
class XBeeProtocol(Enum):
    ...
    def determine_protocol(hardware_version, firmware_version):
        ...
        | Args:
        |     hardware_version (Integer): hardware version of the protocol to
                                          determine.
        |     firmware_version (String): firmware version of the protocol to
                                         determine.

        Returns:
            The XBee protocol corresponding to the given hardware and firmware 
            versions.
        """
